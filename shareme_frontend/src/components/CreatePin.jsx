            ...
            {!imageAsset ? (
              ...
              <label>
                <div className="flex flex-col items-center justify-center h-full">
                  ...
                  <p className="mt-32 text-xl text-gray-400">
          ...
          {user && (
            <div className="flex gap-2 mt-2 mb-2 items-center bg-white rounded-lg ">
              <img
                ...
                alt="user-profile"
              />
              <p className="text-gray-500 font-bold">{user.userName?.slice(0,20)}</p>
            </div>
          )}
          <input
            type="text"
          ...
          <div className="flex flex-col">
            ...
            <div className="flex justify-end items-end mt-5">
              <button
                type="button"
                onClick={savePin}
                className="bg-red-500 text-xl text-white p-2 pl-4 pr-4 rounded-full w-auto outline-none"
              >
                Save Pin
              </button>
            </div>
